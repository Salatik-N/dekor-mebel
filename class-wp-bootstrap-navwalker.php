...
if ( ! class_exists( 'WP_Bootstrap_Navwalker' ) ) :
	...
	class WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public static function fallback( $args ) {
			...
			$fallback_output .= '</ul>';
			$fallback_output .= '<div class="menu-contacts">THIS IS A TEST MENU DIV11</div>';

			// Menu container closing tag.
			if ( $show_container ) {
				$fallback_output .= '</' . $args['container'] . '>';
				$fallback_output .= '<div class="menu-contacts">THIS IS A TEST MENU DIV AFTER CONTAINER</div>';
			}
